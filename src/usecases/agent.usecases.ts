...
@Injectable()
export class UpdateAgentUseCase implements UseCase<
  { id: string; data: UpdateAgentRequestDTO },
  AgentEntity
> {
  ...
  async execute({
    ...
    if (data.propertiesCount !== undefined)
      entity.propertiesCount = data.propertiesCount;
    if (data.averageRating !== undefined)
      entity.averageRating = data.averageRating;
...
@Injectable()
export class FindAgentByIdUseCase implements UseCase<
  string,
  AgentEntity | null
> {
  constructor(private readonly repository: IAgentRepository) {}
...
@Injectable()
export class FindAgentByUserIdUseCase implements UseCase<
  string,
  AgentEntity | null
> {
  constructor(private readonly repository: IAgentRepository) {}
