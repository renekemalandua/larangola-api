...
import { CreateAgentPlanRequestDTO, UpdateAgentPlanRequestDTO } from '../dto/agent-plan.dto';

@Injectable()
export class CreateAgentPlanUseCase implements UseCase<CreateAgentPlanRequestDTO, AgentPlanEntity> {
...
@Injectable()
export class UpdateAgentPlanUseCase implements UseCase<{ id: string; data: UpdateAgentPlanRequestDTO }, AgentPlanEntity> {
	constructor(private readonly repository: IAgentPlanRepository) { }
	async execute({ id, data }: { id: string; data: UpdateAgentPlanRequestDTO }): Promise<AgentPlanEntity> {
		...
		if (data.pricePeriod !== undefined) entity.pricePeriod = data.pricePeriod ?? null;
...
@Injectable()
export class FindAgentPlanByIdUseCase implements UseCase<string, AgentPlanEntity | null> {
	constructor(private readonly repository: IAgentPlanRepository) { }
