...
export abstract class IAgentSubscriptionRepository {
	abstract create(data: AgentSubscriptionEntity): Promise<AgentSubscriptionEntity>;
	...
	abstract update(data: AgentSubscriptionEntity): Promise<AgentSubscriptionEntity>;
