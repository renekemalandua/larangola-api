...
export abstract class IUserVerificationRepository {
    abstract create(entity: UserVerificationEntity): Promise<UserVerificationEntity>;
    abstract update(entity: UserVerificationEntity): Promise<UserVerificationEntity>;
