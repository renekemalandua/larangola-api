...
export class AgentEntity extends AggregateRoot<IAgentProps> {
	static create(
		props: Optional<IAgentProps, 'profession' | 'company' | 'location' | 'bio' | 'description' | 'isVerified' | 'responseRate' | 'averageResponseTime' | 'propertiesCount' | 'averageRating' | 'createdAt' | 'updatedAt'>,
		id?: IdValueObject,
	) {
